Here's a Python program for a "Team Travel Planning Tool" with update and delete options:
...
2. Add Team Member
3. View Travel Plan
4. Update Travel Plan
5. Update Team Member
6. Delete Team Member
7. Exit
Choose an option: 1
Enter plan name: Paris Trip
Enter destination: Paris
Enter start date (YYYY-MM-DD): 2024
```explain
